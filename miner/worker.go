...
type generateParams struct {
	...
	transactions []*types.Transaction // List of mandatory transactions to be included
}
...
func (w *worker) fillTransactions(interrupt *atomic.Int32, env *environment, inclusionList []*types.Transaction) error {
...
func (w *worker) generateWork(params *generateParams) (*types.Block, *big.Int, error) {
	...
	if !params.noTxs {
		...
		err := w.fillTransactions(interrupt, work, params.transactions)
...
func (w *worker) getSealingBlock(params *generateParams) (*types.Block, *big.Int, error) {
	req := &getWorkReq{
		params: params,
