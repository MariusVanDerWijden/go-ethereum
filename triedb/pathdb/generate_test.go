...
func TestGenerateExistentStateWithWrongAccounts(t *testing.T) {
	...
	// Wrong accounts
	{
		...
		helper.addSnapAccount("acc-2", &types.StateAccount{Balance: uint256.NewInt(1), Root: stRoot, CodeHash: common.BytesToHash(common.Hex2Bytes("0x1234"))})
	...
	// Extra accounts, only in the snap
	{
		...
		helper.addSnapAccount("acc-5", &types.StateAccount{Balance: uint256.NewInt(1), Root: types.EmptyRootHash, CodeHash: common.BytesToHash(common.Hex2Bytes("0x1234"))})  // Middle
		helper.addSnapAccount("acc-7", &types.StateAccount{Balance: uint256.NewInt(1), Root: types.EmptyRootHash, CodeHash: types.EmptyCodeHash}) // after the end
	}
...
func TestGenerateFromEmptySnap(t *testing.T) {
	...
	for i := 0; i < 400; i++ {
		...
		helper.addTrieAccount(fmt.Sprintf("acc-%d", i), &types.StateAccount{Balance: uint256.NewInt(1), Root: stRoot, CodeHash: types.EmptyCodeHash})
	}
